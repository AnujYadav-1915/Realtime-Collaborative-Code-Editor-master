    ...
    return (
        <div className="fixed top-24 right-8 z-[9999] flex flex-col items-end gap-1 p-3 rounded-xl shadow-2xl bg-theme-bgSurface border-2 border-theme-accent">
            ...
            <select 
                ...
                className="bg-theme-smallBoxBg text-theme-textPrimary border border-theme-borderColor rounded-lg px-3 py-2 text-sm font-medium shadow-sm transition-all outline-none cursor-pointer"
            >
                {colorSchemes.map(c => (
