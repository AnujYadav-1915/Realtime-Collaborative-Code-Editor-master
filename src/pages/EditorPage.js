...
const EditorPage = () => {
  ...
  return (
    <div className={`mainWrap editorPageLayout ${editorThemeClass}${isSidebarCollapsed ? " sidebarCollapsed" : ""}`}>
      ...
      <div className="editorPageFooterInfo">
        <div>
          <strong>About Sync Code</strong>
          <p>
            Sync Code is a real-time collaborative interview platform for coding rounds, pair problem-solving,
            AI-assisted feedback, and structured practice.
          </p>
        </div>
        <div>
          <strong>Founder</strong>
          <p>Anuj Kumar — focused on building interview-first, collaboration-first developer tools.</p>
        </div>
        <div>
          <strong>Contact</strong>
          <p>Email: anujyadav1112@gmail.com · LinkedIn: Anuj Kumar</p>
        </div>
      </div>
      {isAiDrawerOpen && (
